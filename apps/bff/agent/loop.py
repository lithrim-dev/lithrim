...
_SYSTEM_PROMPT = (
    ...
    "side pane. The human's Save IS the audited write; $0, you only surface. (When YOU already know "
    "the contract_type + params, use add_grounding_contract — the agent-composes twin — instead.)\n"
