...
_EXPECTED_FLOOR = {"structural_jute", "jute_gen", "value_presence", "value_grounding", "attribute_consistency",
                   # KPI-FLOOR-1: the deterministic record-field checks (threshold/range, allowed set).
                   "kpi_threshold", "field_in_set",
...
_EXPECTED_CONTRACT_PLUGINS = {
    ...
    # KPI-FLOOR-1: pure-stdlib record-field floors.
    "kpi_threshold": ("contract", "core", "in_process", "grounding.floor"),
    "field_in_set": ("contract", "core", "in_process", "grounding.floor"),
